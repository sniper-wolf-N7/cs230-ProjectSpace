...
def compute_melgram(audio_path):
    ...
    NOTE: I have changed the command to compute melgram, because we are using amplitude_to_db, there is no need to have melspectogram to power 2,  logamplitude(S**2) = amplitude_to_db (S)
