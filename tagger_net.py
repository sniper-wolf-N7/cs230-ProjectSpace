...
def MusicTaggerCRNN(weights='msd', input_tensor=None):
    ...
    x = GRU(32, return_sequences=True, name='gru1',trainable=False)(x)
    x = GRU(32, return_sequences=False, name='gru2',trainable=False)(x)
    x = Dropout(0.3, name='final_drop',trainable=False)(x)
